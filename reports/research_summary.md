...
- Dataset version: `synthetic-v1`; cases: 600; conditions: 20.
...
Paired McNemar contrast of decision correctness (with vs without deterministic evidence), n_pairs=5400: accuracy 0.558 vs 0.533, p=<0.001 (method: chi2_continuity), BH-adjusted p=<0.001.
...
Paired contrast of the unsupported-claim rate, zero-shot vs evidence-constrained, n_pairs=3000: 0.204 vs 0.045 (difference 0.158, Cohen's h=0.507, permutation p=<0.001, BH-adjusted p=<0.001).
...
Pre/post reviewer (paired by case, n=4800): accuracy 0.545 -> 0.552; false-positive rate 0.209 -> 0.200; McNemar p=<0.001 (BH-adjusted p=<0.001).
